...
#
# Created: Sat Nov 17 16:44:11 2012
...
" } "))
        ...
        self.gridLayout_5.addWidget(self.everySecondOption, 6, 0, 1, 1)
        self.everyTwoSecondsOption = QtGui.QRadioButton(self.groupBox)
        self.everyTwoSecondsOption.setChecked(False)
        self.everyTwoSecondsOption.setObjectName(_fromUtf8("everyTwoSecondsOption"))
        self.gridLayout_5.addWidget(self.everyTwoSecondsOption, 7, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.startFrame, 10, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.segProgress, 15, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.highlightFacesOption, 13, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.lastFrameButton, 12, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.endFrame, 12, 0, 1, 1)
        spacerItem1 = QtGui.QSpacerItem(0, 0, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout_5.addItem(spacerItem1, 17, 0, 1, 2)
        self.onFaceClustersOption = QtGui.QRadioButton(self.groupBox)
        self.onFaceClustersOption.setChecked(True)
        self.onFaceClustersOption.setObjectName(_fromUtf8("onFaceClustersOption"))
        self.gridLayout_5.addWidget(self.onFaceClustersOption, 8, 0, 1, 1)
...
" } "))
        ...
        MainWindow.setTabOrder(self.blackFramesOption, self.startFrame)
